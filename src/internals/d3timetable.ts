export const d3timetable = ((d3, commons) => {
    ...
    return (config) => {
        ...
        const draw = (elem, props) => {
            ...
            let layers =  makelayers(xvar, yvars, allowed, data, onclick, tooltip)
       ...
       const makelayers = (xvar, yvars, allowed, eventdefs, onclick, tooltip) => {
